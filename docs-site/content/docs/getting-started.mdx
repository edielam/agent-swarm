...
- [Claude Code](https://docs.anthropic.com/en/docs/claude-code) installed, with an OAuth token (`claude setup-token`)
...
|----------|------|----------|
| **Lead** | `lead` | Orchestrating workers, decomposing tasks, managing epics |
