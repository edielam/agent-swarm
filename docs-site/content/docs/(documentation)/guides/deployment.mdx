...
|--------|-----------|---------|-------------|
| `swarm_api` | **Yes** | **Yes** | Contains the SQLite database (`agent-swarm-db.sqlite`) with all tasks, agents, epics, schedules, and configuration. Losing this = losing all swarm state. |
